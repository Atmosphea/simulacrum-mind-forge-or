...
import { Brain, Home, FolderOpen, Users, BarChart3, Settings, Plus, Search, User } from 'lucide-react';
...
const DashboardSidebar = () => {
  ...
  return (
    <div className="w-64 glass-card backdrop-blur-xl border-r border-white/20 h-screen flex flex-col" 
